...
import datetime
from lib.SegNet.segnet import segnet
...
def train():
    ...
    logdir = 'D:/soyeon_vision2022/01.Object_segmentation_start/03.code/old/ATLAS_models/SegNet_in2d_out2d'+model_name+'_v1_Dice_IoULoss_'+str(img_depth)
    ...
    model = segnet(n_classes=n_classes, in_channels=1).cuda()
...
if __name__ == '__main__':
    ...
    test_score_list = []
    model_name = "SegNet_ATLAS_test"
    logdir = 'D:/soyeon_vision2022/01.Object_segmentation_start/03.code/old/ATLAS_models/SegNet_in2d_out2d' + model_name + '_v1_Dice_IoULoss_' + str(1)

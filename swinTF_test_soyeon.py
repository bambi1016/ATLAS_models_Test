...
import os
from lib.loader import CustomDataset_3d_gray, CustomDataset2_gray,CustomDataset,CustomDataset2
import datetime
...
def test(model, device):
    ...
    logdir = 'D:/soyeon_vision2022/01.Object_segmentation_start/03.code/old/ATLAS_models/swinTF_in2d_out2d_test'
    ...
    test_data = DataLoader(CustomDataset2(test_data_list, test_mask_list), batch_size=8, shuffle=True, num_workers=4)
    n_classes = 2
...
if __name__ == '__main__':
    ...
    model_path = "swinTF_in2d_out2dswinTF_ATLAS_test_v1_Dice_IoULoss_1/swinTF_ATLAS_test_best_model.pth"

    net = SwinTransformerSegmentation(img_size=224,
                                        patch_size=4,
                                        in_chans=3,
                                        num_classes=2,
                                        embed_dim=96,

...
import datetime
from lib.pspnet_model.pspnet import PSPNet
...
def train():
    ...
    logdir = 'D:/soyeon_vision2022/01.Object_segmentation_start/03.code/old/ATLAS_models/PSPNet_in2d_out2d'+model_name+'_v1_Dice_IoULoss_'+str(img_depth)
...
if __name__ == '__main__':
    ...
    test_score_list = []
    model_name = "PSPNet_ATLAS_test"
    logdir = 'D:/soyeon_vision2022/01.Object_segmentation_start/03.code/old/ATLAS_models/PSPNet_in2d_out2d' + model_name + '_v1_Dice_IoULoss_' + str(1)

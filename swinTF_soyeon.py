...
import os
from lib.loader import CustomDataset2_gray,CustomDataset, CustomDataset2
...
from lib.swin_hardnet import SwinTransformerSegmentation
import numpy as np
...
def train():
    ...
    logdir = 'D:/soyeon_vision2022/01.Object_segmentation_start/03.code/old/ATLAS_models/swinTF_in2d_out2d'+model_name+'_v1_Dice_IoULoss_'+str(img_depth)
    ...
    train_data = DataLoader(CustomDataset2(train_data_list, train_mask_list), batch_size=batch_size, shuffle=True, num_workers=4)
    val_data   = DataLoader(CustomDataset2(val_data_list, val_mask_list), batch_size=batch_size, shuffle=True, num_workers=4)
...
if __name__ == '__main__':
    ...
    test_score_list = []
    model_name = "swinTF_ATLAS_test"
    logdir = 'D:/soyeon_vision2022/01.Object_segmentation_start/03.code/old/ATLAS_models/swinTF_in2d_out2d' + model_name + '_v1_Dice_IoULoss_' + str(1)

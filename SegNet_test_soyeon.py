...
def test(model, device):
    ...
    logdir = 'D:/soyeon_vision2022/01.Object_segmentation_start/03.code/old/ATLAS_models/SegNet_in2d_out2d_test'
...
if __name__ == '__main__':
    ...
    model_path = "SegNet_in2d_out2dSegNet_ATLAS_test_v1_Dice_IoULoss_1/SegNet_ATLAS_test_best_model.pth"

    net = segnet(n_classes=2, in_channels=1).cuda()

...
def test(model, device):
    ...
    logdir = 'D:/soyeon_vision2022/01.Object_segmentation_start/03.code/old/ATLAS_models/PSPNet_in2d_out2d_test'
...
if __name__ == '__main__':
    ...
    model_path = "PSPNet_in2d_out2dPSPNet_ATLAS_test_v1_Dice_IoULoss_1/PSPNet_ATLAS_test_best_model.pth"

    net = PSPNet(layers=50, bins=(1, 2, 3, 6), dropout=0.1, classes=2, zoom_factor=8, use_ppm=True,
